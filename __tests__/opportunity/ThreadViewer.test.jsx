...
const messages = [
  { id: 'm1', direction: 'sent',     from_address: 'me@gmail.com',  subject: 'Application for Engineer', snippet: 'I am applying...',     received_at: '2026-06-01T10:00:00Z', signal_type: null },
  { id: 'm2', direction: 'received', from_address: 'hr@acme.com',   subject: 'Re: Application',          snippet: 'Thanks for applying!',  received_at: '2026-06-05T14:00:00Z', signal_type: 'interview_invite' },
]
...
test('renders signal_type label when present', () => {
  render(<ThreadViewer messages={messages} />)
